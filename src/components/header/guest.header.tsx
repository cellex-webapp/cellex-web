  ...
  return (
    <header className="w-full flex items-center px-4 md:px-8 py-3 bg-white border-b border-gray-200 gap-4 md:gap-6 lg:gap-10">
      <div className="flex items-center min-w-fit">
        <Link to="/">
          <img src={logo} alt="Logo" className="h-10 md:h-14 lg:h-10" />
        </Link>
        <span className="text-primary font-bold ml-2 text-lg md:text-xl tracking-wide text-primary-500 hidden sm:inline">
          CELLEX
        </span>
      </div>
